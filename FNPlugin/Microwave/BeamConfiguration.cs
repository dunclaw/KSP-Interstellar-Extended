...
namespace FNPlugin.Microwave
{
    public class BeamConfiguration : PartModule
    {
		...
		[KSPField(isPersistant = true, guiActiveEditor = false, guiActive = false, guiName = "Power to Beam Efficiency 0", guiFormat = "F0", guiUnits = "%")]
		...
		[KSPField(isPersistant = true, guiActiveEditor = false, guiActive = false, guiName = "Power to Beam Efficiency 1", guiFormat = "F0", guiUnits = "%")]
		...
		[KSPField(isPersistant = true, guiActiveEditor = false, guiActive = false, guiName = "Power to Beam Efficiency 2", guiFormat = "F0", guiUnits = "%")]
		...
		[KSPField(isPersistant = true, guiActiveEditor = false, guiActive = false, guiName = "Power to Beam Efficiency 3", guiFormat = "F0", guiUnits = "%")]
